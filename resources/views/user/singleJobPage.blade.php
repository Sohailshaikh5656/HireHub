  ...
  @include('user.common.header')
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h1 class="text-white font-weight-bold">{{$jobData->job_post_name}}</h1>
            <div class="custom-breadcrumbs">
              <a href="#">Home</a> <span class="mx-2 slash">/</span>
              <a href="#">Job</a> <span class="mx-2 slash">/</span>
              <span class="text-white"><strong>{{$jobData->job_post_name}}</strong></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="site-section">
      <div class="container">
        <div class="row align-items-center mb-5">
          <div class="col-lg-8 mb-4 mb-lg-0">
            ...
            <div class="alert alert-success">
              <ul>
                      <li>You Applied Successfully for this Post !</li>
                      @php
            ...
            <div class="alert alert-danger">
              <ul>
                      <li>JYou Already Applied for this Post !</li>
                      @php
            ...
            <div class="d-flex align-items-center">
              <div class="border p-2 d-inline-block mr-3 rounded">
                <img src="{{ asset('images/agencyData/' . $agency_profile->image_url) }}" alt="Image" style="max-width: 300px">
              </div>
              <div>
                <h2>{{$jobData->job_post_name}}</h2>
                <div>
                  <span class="ml-0 mr-2 mb-2"><span class="icon-briefcase mr-2"></span>{{$agency->agency_name}}</span>
                  <span class="m-2"><span class="icon-room mr-2"></span>{{$state->state_name}}, {{$city->city_name}}</span>
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="mb-5">
              <figure class="mb-5"><img src="{{ asset('images/agencyData/' . $agency_profile->image_url) }}" alt="Image" class="img-fluid rounded" style="max-width: 720px; min-width: 400px;"></figure>
              <h3 class="h5 d-flex align-items-center mb-4 text-primary"><span class="icon-align-left mr-3"></span>Job Description</h3>
              <ul class="list-unstyled m-0 p-0">
                @foreach (explode(';',$jobData->description) as $line)
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>{{$line}}</span></li>
                @endforeach
            ...
            <div class="mb-5">
              <h3 class="h5 d-flex align-items-center mb-4 text-primary"><span class="icon-rocket mr-3"></span>Requirement</h3>
              <ul class="list-unstyled m-0 p-0">
                @foreach (explode(';',$jobData->requirement) as $line)
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>{{$line}}</span></li>
                @endforeach
            ...
            <div class="mb-5">
              ...
              <ul class="list-unstyled m-0 p-0">
                @foreach (explode(';',$jobData->benefit) as $line)
                <li class="d-flex align-items-start mb-2"><span class="icon-check_circle mr-2 text-muted"></span><span>{{$line}}</span></li>
            ...
            <div class="row mb-5">
              ...
              <div class="col-6">
                <a href="/user/apply/{{$jobData->id}}" class="btn btn-block btn-primary btn-md">Apply Now</a>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="bg-light p-3 border rounded mb-4">
              ...
              <ul class="list-unstyled pl-3 mb-0">
                <li class="mb-2"><strong class="text-black">Published on:</strong>{{$jobData->created_at}}</li>
                ...
                <li class="mb-2"><strong class="text-black">Experience:</strong> {{ intval($jobData->min_experience) == $jobData->min_experience ? intval($jobData->min_experience) : rtrim(rtrim(number_format($jobData->min_experience, 2), '0'), '.') }}
                   to {{ intval($jobData->max_experience) == $jobData->max_experience ? intval($jobData->max_experience) : rtrim(rtrim(number_format($jobData->max_experience, 2), '0'), '.') }} year(s)</li>
                <li class="mb-2"><strong class="text-black">Job Location:</strong> </li>
                <li class="mb-2"><strong class="text-black">Salary:</strong> &#8377; {{ intval($jobData->min_salary) == $jobData->min_salary ? intval($jobData->min_salary) : rtrim(rtrim(number_format($jobData->min_salary, 2), '0'), '.') }} - 
                  &#8377; {{ intval($jobData->max_salary) == $jobData->max_salary ? intval($jobData->max_salary) : rtrim(rtrim(number_format($jobData->max_salary, 2), '0'), '.') }} Lakh / Per Aanum</li>
                <li class="mb-2"><strong class="text-black">Gender:</strong> Any</li>
                <li class="mb-2"><strong class="text-black">Application Deadline:</strong> {{$jobData->Deadline}}</li>
              </ul>
            </div>
