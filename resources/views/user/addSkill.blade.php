...
<div class="site-wrap">
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');" id="home-section">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <h1 class="text-white font-weight-bold">Add Skill Page</h1>
                    <div class="custom-breadcrumbs">
                        <a href="/user/Home">Home</a> <span class="mx-2 slash">/</span>
                        <span class="text-white"><strong>User Skill Page</strong></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="site-section vh-200" style="background-image: url('{{ asset('user_mat/images/bk1.jpg') }}');">
        ...
        <form action="/user/storeSkill" class="form1" method="post">
            @csrf
            @if ($errors->any())
            ...
            @endif
            <h1 class="text-center1" style="color:#fff;">Add Skill</h1>
        
            <div class="form-step1 form-step-active1">
                <div class="input-group1">
                    <label for="storeSkill">Skill Name</label>
                    <input type="text" name="skill" id="certificateName" placeholder="Ex: Python Trainee" value="{{ old('certificateName') }}">
                </div>
                
                <div class="btns-group1">
                    <button type="submit" class="btn btn-primary p-3">Add Skill</button>
                </div>
            </div>
        </form>
