...
<div class="site-wrap">
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url({{ asset ('user_mat/images/hero_1.jpg')}});" id="home-section">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <h1 class="text-white font-weight-bold">Agency Forget Password Page</h1>
                    <div class="custom-breadcrumbs">
                        <a href="/user/Home">Home</a> <span class="mx-2 slash">/</span>
                        <span class="text-white"><strong>Agency Forget Password Page</strong></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="site-section" style="background-image: url('{{ asset('user_mat/images/bk1.jpg') }}');">
                        ...
                        <form action="/user/agencyForgetPasswordEmail" class="form1" method="post">
                            @csrf
                            @if ($errors->any())
                            ...
                            @endif
                            <h1 class="text-center1" style="color:#fff;">Agency Forget Password</h1>
                            <!-- Progress Bar -->
