      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card"><a href="/Myadmin/newJobListing">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">New Job listing </h3>
                    ...
                    <h6 class="text-muted font-weight-normal">Recent Job Posting, Last 24 hours</h6>
                  </div>
                </div>
            </a></div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card"><a href="/Myadmin/topJobListing">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">Top JobListing Reports<br /></h3>
                    ...
                    <h6 class="text-muted font-weight-normal">Top Most Popular Job category</h6>
                  </div>
                </div>
            </a></div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card"><a href="/Myadmin/expiresJob">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0"> Expire Jobs Data <br></h3>
                    ...
                    <h6 class="text-muted font-weight-normal">Hole data of Expire job</h6>
                  </div>
                </div>
            </a> </div>
