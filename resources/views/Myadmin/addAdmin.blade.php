...
<html lang="en">
  <head>
    ...
    <title>HireHub | Add New Admin</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
            <div class="content-wrapper">
               ...
               <div class="page-header">
                   <h3 class="page-title"> Form | Add Admin</h3>
                 ...
                 <div class="row">
                   ...
                   <div class="col-md-6 grid-margin stretch-card">
                     <div class="card">
                       <div class="card-body">
                         <h4 class="card-title">HireHub | Add Admin</h4>
                         <p class="card-description"> Horizontal form layout </p>
                         <form class="forms-sample" action="addAdmin" method="post">
                            @csrf
                                                                    @if ($errors->any())
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <input type="text" class="form-control" id="exampleInputUsername2" placeholder="Enter Name" name="name" required>
                                </div>
                              </div>
                           ...
                           <div class="form-group row">
                             ...
                             <div class="col-sm-9">
                               <input type="email" class="form-control" id="exampleInputUsername2" placeholder="Enter Email" name="email" required>
                             </div>
                           </div>
                           <div class="form-group row">
                               <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Password</label>
                               <div class="col-sm-9">
                                 <input type="password" class="form-control" id="exampleInputUsername2" placeholder="Enter Password" name = "password"required>
                               </div>
                             </div>
                           ...
                           {{-- <div class="form-group row">
                             ...
                             <div class="col-sm-9">
                               <input type="email" class="form-control" id="exampleInputEmail2" placeholder="Job Sub Catagory Description">
                             </div>
                           </div> --}}
                           {{-- <div class="form-group row">
                               ...
                               <div class="form-check">
                                   <label class="form-check-label">
                                     <input type="radio" class="form-check-input" name="status" id="optionsRadios1" value="Active"> Active &nbsp;&nbsp;&nbsp;</label>
                                 </div>
                                 <div class="form-check">
                                   <label class="form-check-label">
                           ...
                           <button class="btn btn-dark" onclick="window.location.href='http://127.0.0.1:8000/Myadmin/adminDashboard'">Cancel</button>
                         </form>
                       </div>
                     </div>
                   </div>
