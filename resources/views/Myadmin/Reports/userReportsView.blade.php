      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card"><a href="/Myadmin/newUserRegistration">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">User Registartation </h3>
                    ...
                    <h6 class="text-muted font-weight-normal">New Registatrtion till Last Month</h6>
                  </div>
                </div>
            </a></div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card"><a href="/Myadmin/activeInactiveUser">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">Active and Inactive User Reports<br /></h3>
                    ...
                    <h6 class="text-muted font-weight-normal">Based on last month. Report wil be Generated</h6>
                  </div>
                </div>
            </a></div>
