      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card ml-4"><a href="">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">Success : {{$data->success}} </h3>
                    ...
                    <h6 class="text-muted font-weight-normal">Success Login Attemp</h6>
                  </div>
                </div>
            </a></div>
              
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card"><a href="">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">failure :  {{$data->fail}} <br></h3>
                    ...
                    <h6 class="text-muted font-weight-normal">failure Login Attemp</h6>
                  </div>
                </div>
            </a> </div>
