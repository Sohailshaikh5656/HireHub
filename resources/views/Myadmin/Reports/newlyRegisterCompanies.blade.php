                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 d-flex justify-content-between">
                                <h4 class="card-title">Recent Newly Register Account </h4>
                                <a class="btn btn-primary" href="/Myadmin/PDF_newlyRegisterCompanies">Download PDF</a>
                            </div>
                        </div>
                ...
                <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 d-flex justify-content-between">
                                <h4 class="card-title">UnAuthorized Account </h4>
