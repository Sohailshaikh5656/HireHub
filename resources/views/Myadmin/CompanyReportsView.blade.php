      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card"><a href="/Myadmin/newlyRegisterCompanies">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">New Register Company </h3>
                    ...
                    <h6 class="text-muted font-weight-normal">Companies Reports Releated Authorized or Newly Register Companies</h6>
                  </div>
                </div>
            </a></div>
