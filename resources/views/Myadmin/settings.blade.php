...
<html lang="en">
  <head>
    ...
    <title>HireHub | Admin Settingd</title>
    <!-- plugins:css -->
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card"><a href="AdminDashboard">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0"> Site Name and Logo </h3>
                    ...
                    <h6 class="text-muted font-weight-normal">Update the job portal name, logo, and favicon.</h6>
                  </div>
                </div>
            </a></div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card"><a href="AdminDashboard">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">User Registration Settings<br /></h3>
                    ...
                    <h6 class="text-muted font-weight-normal">Enable or disable user registration</h6>
                  </div>
                </div>
            </a></div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card"><a href="AdminDashboard">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0"> Theme and Appearance <br></h3>
                    ...
                    <h6 class="text-muted font-weight-normal">Customize the site theme</h6>
                  </div>
                </div>
            </a> </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card"><a href="AdminDashboard">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">Job Post Settings</h3>
                          <p class="text-success ml-2 mb-0 font-weight-medium">+</p>
                        </div>
                      </div>
                      <div class="col-3">
                    ...
                    <h6 class="text-muted font-weight-normal">Set limits on the number of job postings per company</h6>
                  </div>
                </div>
              </div>
            </a></div>
