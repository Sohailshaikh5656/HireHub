                ...
                <div class="col-md-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample" action="/Myadmin/updateSubJob/{{$data->id}}" method="post">
                        @csrf
                        @method('PUT')
                        @if ($errors->any())
                        ...
                        <div class="form-group row">
                          <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Job Post Name</label>
                          <div class="col-sm-9">
                            <input type="text" name="name" value="{{$data->job_sub_category}}" class="form-control" id="exampleInputUsername2" placeholder="Enter Sub Catagory Name">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select class="form-control" name="category">
                                @foreach ($cat as $cat)
                                <option value="{{$cat->id}}"{{ $data->jobcategory_id==$cat->id?'selected' : ''}}>{{$cat->category_name}}</option>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="description" value = "{{$data->description}}" class="form-control" id="exampleInputEmail2" placeholder="Job Sub Catagory Description">
                          </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                  <input type="radio" name="status" class="form-check-input" name="status" id="optionsRadios1" value=1 {{$data->status==1 ?'checked' : ''}}> Active &nbsp;&nbsp;&nbsp;</label>
                              </div>
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="status" id="optionsRadios2" value=0 {{$data->status==0 ?'checked' : ''}}> Inactive </label>
                              </div>
                        </div>
